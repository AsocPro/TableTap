...
export namespace Obstacle {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Obstacle): void {
    Obstacle.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Obstacle {
    return Obstacle.getTypeScriptAlgebraicType().deserialize(reader);
  }
